...
export type AssessmentRow={id:string;school_id:string;session_id:string;term_id:string;class_id:string;subject_id:string;title:string;assessment_type:string;max_score:number;weight:number;due_date:string|null;workflow_status:"draft"|"review"|"approved"|"published";published:boolean};
